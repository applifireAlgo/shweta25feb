...
folder are mapped to the application's root namespace, 'Mobile1aprl'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Mobile1aprl"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Mobile1aprl' in the same way
as `"Mobile1aprl/sass/src"`.

 ...
 */
Ext.define('Mobile1aprl.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Mobile1aprl.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Mobile1aprl.store.QueryCriteriaWidgetsStore' ],

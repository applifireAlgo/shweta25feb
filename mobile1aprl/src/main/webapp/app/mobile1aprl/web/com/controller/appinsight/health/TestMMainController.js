Ext.define('Mobile1aprl.mobile1aprl.web.com.controller.appinsight.health.TestMMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#TestMForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#TestMForm');
          var grid = this.view.down('#TestMGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#TestMGrid');
               ...
               var formPanel = this.getView().up().down('#TestMForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#TestMTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TestMForm').down('#' + me.column.dataIndex + '').store;

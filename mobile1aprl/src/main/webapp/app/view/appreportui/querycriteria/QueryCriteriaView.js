Ext.define('Mobile1aprl.view.appreportui.querycriteria.QueryCriteriaView',{
	extend : 'Ext.panel.Panel',
	requires : [ 'Mobile1aprl.view.appreportui.querycriteria.QueryCriteriaViewController' ],

 ...
 * 
 */
Ext.define('Mobile1aprl.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Mobile1aprl.view.logalarm.mainscreen.AddLogAlarmController',
			'Mobile1aprl.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Mobile1aprl.view.logalarm.mainscreen.AppAlarmPanel',

 ...
 * 
 */
Ext.define('Mobile1aprl.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Mobile1aprl.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});

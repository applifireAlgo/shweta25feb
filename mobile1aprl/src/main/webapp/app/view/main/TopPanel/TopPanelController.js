Ext.define('Mobile1aprl.view.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Mobile1aprl.view.scheduler.scheduler"
		var component = Ext.create(
				"Mobile1aprl.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});

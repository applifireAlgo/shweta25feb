...
Ext.define('Mobile1aprl.view.main.TopPanel.TopMenuController', {
 						...
 						menuData.push(
 						{
 							...
 							renderCentralPanel:function(currentObject,menu)
 							{
 								if(menu.config.data.uiType && menu.config.data.uiType=='M')
 								{
 	 									...
 	 									var component = Ext.create('Mobile1aprl.view.art.masterform.MasterPanel',{closable : true,title: menu.text, artMasterFormId:menu.config.data.refId});

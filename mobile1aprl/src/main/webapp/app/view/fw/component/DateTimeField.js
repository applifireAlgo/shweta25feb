 ...
 */
Ext.define('Mobile1aprl.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Mobile1aprl.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Mobile1aprl.view.fw.component.DateTimePicker(o);
    },

Ext.define('Mobile1aprl.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Mobile1aprl.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive"
					//refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Mobile1aprl.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile"
				});
	...
	{
		var component = Ext.create(
				"Mobile1aprl.view.usermanagement.enduser.ChangePwd", {
					closable : true,

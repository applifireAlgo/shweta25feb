Ext.define('Mobile1aprl.view.mobileview.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Mobile1aprl.view.mobileview.scheduler.scheduler"
		var component = Ext.create(
				"Mobile1aprl.view.mobileview.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Mobile1aprl.view.mobileview.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});

...
Ext.define('Mobile1aprl.view.mobileview.main.TopPanel.TopMenuController', {
 						...
 						menuData.push(
 						{
 							...
 							renderCentralPanel:function(currentObject,menu)
 							{
 								if(menu.config.data.uiType && menu.config.data.uiType=='M')
 								{
 	 									...
 	 									var component = Ext.create('Mobile1aprl.view.mobileview.art.masterform.MasterPanel',{closable : true,title: menu.text, artMasterFormId:menu.config.data.refId});

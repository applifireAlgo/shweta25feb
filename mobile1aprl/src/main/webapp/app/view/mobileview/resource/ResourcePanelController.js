Ext.define('Mobile1aprl.view.mobileview.resource.ResourcePanelController', {
	...
	createTreePanel : function(current, data)
	{
				...
				for (var j = 0; j < this.formResourcePanel.items.length; j++) {
					...
					if(me.formResourcePanel.items.items[j].title == record.menuLabel)
						{
							var treePanel = new Ext.create('Mobile1aprl.view.mobileview.resource.AppMenuTreePanel');

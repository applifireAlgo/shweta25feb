Ext.define('Mobile1aprl.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Mobile1aprl.view.usermanagement.admin.AddUserDetailsViewModel', 'Mobile1aprl.model.AddUserDataModel' ],

Ext.define('Mobile1aprl.view.usermanagement.roles.EditRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Mobile1aprl.view.usermanagement.roles.EditRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],

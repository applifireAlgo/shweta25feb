Ext.define('Mobile1aprl.view.usermanagement.roles.AddNewRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Mobile1aprl.view.usermanagement.roles.AddNewRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],

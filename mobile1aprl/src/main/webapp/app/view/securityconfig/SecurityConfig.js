 ...
 * 
 */
Ext.define('Mobile1aprl.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Mobile1aprl.view.securityconfig.SecurityConfigController',
			'Mobile1aprl.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',

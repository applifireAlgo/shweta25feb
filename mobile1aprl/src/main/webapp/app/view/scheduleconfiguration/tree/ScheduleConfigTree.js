 ...
 * 
 */
Ext.define("Mobile1aprl.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Mobile1aprl.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],

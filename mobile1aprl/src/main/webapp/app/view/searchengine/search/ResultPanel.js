Ext
		.define(
				'Mobile1aprl.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Mobile1aprl.view.searchengine.search.SearchEngineMainPanelController','Mobile1aprl.view.searchengine.search.PanelHeaderField' ,'Mobile1aprl.view.searchengine.search.ReportGridView','Mobile1aprl.view.searchengine.search.ReportChartView','Mobile1aprl.view.searchengine.search.documentView','Mobile1aprl.view.searchengine.search.DouMeanView','Mobile1aprl.view.googlemaps.map.MapPanel'],

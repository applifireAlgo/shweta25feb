Ext.define('Mobile1aprl.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Mobile1aprl.view.searchengine.search.NorthPanel', 'Mobile1aprl.view.searchengine.search.SearchResult','Mobile1aprl.view.searchengine.search.SearchEngineMainPanelController'],

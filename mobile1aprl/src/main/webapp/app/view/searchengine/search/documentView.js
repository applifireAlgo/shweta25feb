Ext
		.define(
				'Mobile1aprl.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Mobile1aprl.view.searchengine.search.documentController',
							'Mobile1aprl.view.searchengine.search.RowExpander' ],

...
Ext
		.define(
				'Mobile1aprl.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Mobile1aprl.view.logger.tabs.details.DetailsTab',
							'Mobile1aprl.view.logger.tabs.fileconnector.FileConnectorTab',
							'Mobile1aprl.view.logger.tabs.dbconnector.DBConnectorTab',
							'Mobile1aprl.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Mobile1aprl.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Mobile1aprl.view.logger.LogConfigurationTabPanelController',

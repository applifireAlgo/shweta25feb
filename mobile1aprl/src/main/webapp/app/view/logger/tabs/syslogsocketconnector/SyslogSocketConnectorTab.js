 ...
 * 
 */
Ext.define('Mobile1aprl.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Mobile1aprl.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],

...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccesslevel.setLevelName("uGLOT3lsxXMOp6HWheO2aEtKdtj1qO3n7StrkBaUWoIh171k28");
        useraccesslevel.setLevelIcon("VaeOvBv06as8ThdltWTxtxOEvQngZzpIm4jHJhUqcSgDIwqTCO");
        useraccesslevel.setLevelDescription("DW2pZW9kkMKfyHcbLdxMQkQTL5qxIaLQC51gVKtvZ48tPXODWp");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("1cWQnrddkhBAfwlNjTH8MJ7zi69ogMdnlQjfPXG9WBuOHTFdmL");
        ...
        useraccessdomain.setDomainName("QSryqTXzK7pbBws3zFNCyJGTn78D9PHvVhuomeCnrF5OZkZgGW");
        useraccessdomain.setDomainIcon("kt57Wobr6UDN1Fn0MFxBUmZqYrAcKiIRr3KUE27ZKR6ZjLRevw");
        useraccessdomain.setDomainHelp("x0ii5sFBu0gLkjOzBUFlq2jwJElzoqoE6ZOKXpFC69GxlzsJE1");
        useraccessdomain.setDomainDescription("11nF1I64rNMwvkEAwQ6J5MG4Janwcapq8OBwMkDW7huG1tHCcH");
        ...
        user.setIsDeleted(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1459499549406l));
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setSessionTimeout(2718);
        user.setUserAccessCode(57378);
        user.setIsLocked(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1459499549457l));
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordAlgo("Od1Jwkddu0y9xm830JhUYyYRFktWgcgYrlnIYUR7UNs33UMdHR");
        user.setAllowMultipleLogin(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("LI85y7dsrgfusJriIOPcGUmJhdxuI8VXNDya0ooLDt1SnJeTTD");
        Question question = new Question();
        question.setQuestionIcon("zHwCw8kqY4ijlg8H6Isr5Z6jwNz28eccJGKJhzUIkh0F8G58qF");
        question.setQuestion("UjSV7DCdOe1CQigQwV6h2059mNCveDzAV7WsdD9WFfnZEzKjdO");
        question.setQuestionDetails("XTJtfjRvPG");
        ...
        passrecovery.setAnswer("eEPgMx9Ogyu23O1h9BQw0lfmvRnqxiu75JRRqLNUZ65mkMFEcu");
        passrecovery.setUser(user);
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459499549669l));
        userdata.setPassword("1IBQTuLfqd2eH6jg3EXp9hiqmUHihmTY8cObUGm9soo7enY702");
        userdata.setLast5Passwords("2uAooSxEDbGZySTjn4Euztjyl1QYie5AVjdm4ISeB6QsKMojm9");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1459499549679l));
        userdata.setPassword("OLO2syDEo54ClL5KijivufNK2VGKjFPcaJmOCf02O2jm1UzP32");
        userdata.setLast5Passwords("i5Ls4cF2IDJTGIOjWJW44RsfS8sNYzHdIQb0CvCz5dsJZgXow1");
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(11);
        userdata.setOneTimePassword("KMCPmU4PghkX8CfryR8IxwyXWkbkvC6f");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 99117));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "JkUIrpL5uem8oVMLDi1OOnWyiXycSpF827qn9ICJa1SJrapud9xwtF8kFnKfFL3PN"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6537));

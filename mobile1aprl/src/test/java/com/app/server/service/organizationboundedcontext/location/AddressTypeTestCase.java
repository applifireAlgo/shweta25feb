...
public class AddressTypeTestCase extends EntityTestCriteria {
    ...
    private AddressType createAddressType(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        addresstype.setAddressTypeIcon("uXIvNyPVb6H7e6M94B5wxNGjg7GTYngokYOVRLjU7RJOuRMwL2");
        addresstype.setAddressType("WjPwEyDVdPcHltFFUeyKNheLPKXNZ13dqw1LlhPVUBvf3nrjzB");
        addresstype.setAddressTypeDesc("zqYdHRZDUCvAEvOd6vKO4qWHBGDu8SFUlz6GgA4Pu5tRYR2nGc");
    ...
    public void test2Update() {
        try {
            ...
            addresstype.setAddressTypeIcon("HH8bDEshV7ES41n2fBc7Wy6L6TDDYG87LdycOQJyoUDGk6oPfF");
            addresstype.setAddressType("LjJobs62BvWOi7ZJpAmJ21xwTNqLxyHJyFMFOBqUQcnBkEHGPT");
            addresstype.setAddressTypeDesc("te0RDMULGiFPFKsfxbZ0v41QCj4VCE39Hf8FQV9EeNAevz1EAg");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "addressType", "XEHGw3aOmgxEgrihYj5gIDbSRvwFNp7CtwF1LAROTodUShMq9KDqZ4JPr85bJryrIsgrSehnJGjEAcwS7MAkpvI8UJxQr6mf9CFI7ZAFz11RMr8BSBtUl5wnzati1Aydn"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "addressTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "addressTypeIcon", "9kzjk7sEKEAHH1ymFTmFjAPwrCTDzAWmP3pyhUa2udggv4mXH0WebWmccfDP2mfjtwUOxknA8QrjJrEW6kEJSlFZMSmnsUzf9hqGsAmZ4Mlap3PuxYy2zhBlIedlXECxJ"));

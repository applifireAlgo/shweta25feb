...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        communicationgroup.setCommGroupName("oFGZunYeNdE4qT64AVdEUHRFDxqEpKhQgWFxuNtoK7kUn2MouC");
        communicationgroup.setCommGroupDescription("wCrMZdpMsTSFuEYuzy8gQ2UtWBarvX4KbgD468Nn6NpENl0zw9");
        ...
        communicationtype.setCommTypeName("NYtixIZaeoJAirlh5uidaCGj4o1qSDYK57EpGbT5XyDm6nM73a");
        communicationtype.setCommGroupId((java.lang.String) CommunicationGroupTest._getPrimarykey());
        communicationtype.setCommTypeDescription("pjCqV006JEexAdMLObIqYeMbrefPjgunoYGIrn0WaUHYVMTFlR");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeName("EBLmx7tGPwLl1nLWb0qKHi4S9METgzsq7gIrsSdCpmBOnqQQ4R");
            communicationtype.setVersionId(1);
            communicationtype.setCommTypeDescription("XZcdIFFZpSFciEujRJRYQ30WN8QK9evNROHwufgS2OuVwnrYir");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "vrFj8AnPR8GJWs3UhbAJhL0f558VWhUJUTsx8yU3ZslIKkYdoPfCxYrbpltCyS8DrKJo1cc0kov7Lf6DU3KuVhY7iFjiEhYhgDf56wC9doA9iSz9UNmSuu9BFYAZhtaAU"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));

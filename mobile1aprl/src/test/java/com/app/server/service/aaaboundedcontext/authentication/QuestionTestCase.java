...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionIcon("a7Y057ggrjiKfy5M85laqbsyejHxRVeFHK7BkVPDxOp8xxHg1K");
        question.setQuestion("TXjOVbK70lupC9noXKVHe8kPqk8Zb3xMnH0pCAlY9ECP473bS4");
        question.setQuestionDetails("1mFvWQmfDR");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("OqkXYnpefynidA3i3Q9ljBIQ9w7nGK0qyhAFjiksmLyDj82wXe");
            question.setQuestion("fkJSPRFoxsrZ0p00h7AAKxuvT1QnCGf9FNzxHebODr7HPLIUBD");
            question.setQuestionDetails("EdjB1aU9T5");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "i6ltlBo9FcvID6zEatLykphqGDW3DhyCLQOj2J2u7jqupw0JkuhFYBZ8dr8ARSxBf"));

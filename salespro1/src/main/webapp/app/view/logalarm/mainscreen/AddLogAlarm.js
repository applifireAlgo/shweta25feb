 ...
 * 
 */
Ext.define('Salespro1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Salespro1.view.logalarm.mainscreen.AddLogAlarmController',
			'Salespro1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Salespro1.view.logalarm.mainscreen.AppAlarmPanel',

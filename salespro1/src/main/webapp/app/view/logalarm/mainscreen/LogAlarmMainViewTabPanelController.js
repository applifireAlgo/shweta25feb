 ...
 * 
 */
Ext.define('Salespro1.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Salespro1.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});

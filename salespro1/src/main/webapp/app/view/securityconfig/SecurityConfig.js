 ...
 * 
 */
Ext.define('Salespro1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Salespro1.view.securityconfig.SecurityConfigController',
			'Salespro1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',

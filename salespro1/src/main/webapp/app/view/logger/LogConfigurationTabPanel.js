...
Ext
		.define(
				'Salespro1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Salespro1.view.logger.tabs.details.DetailsTab',
							'Salespro1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Salespro1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Salespro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Salespro1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Salespro1.view.logger.LogConfigurationTabPanelController',

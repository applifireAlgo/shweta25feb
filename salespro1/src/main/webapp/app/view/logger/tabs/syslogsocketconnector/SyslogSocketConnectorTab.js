 ...
 * 
 */
Ext.define('Salespro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Salespro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],

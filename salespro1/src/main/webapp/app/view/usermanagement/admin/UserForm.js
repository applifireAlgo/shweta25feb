Ext.define('Salespro1.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Salespro1.view.usermanagement.admin.AddUserDetailsViewModel', 'Salespro1.model.AddUserDataModel' ],

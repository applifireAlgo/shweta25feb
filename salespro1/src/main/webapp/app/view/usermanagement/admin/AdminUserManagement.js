Ext.define('Salespro1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Salespro1.view.usermanagement.admin.UserPasswordReset',
	            'Salespro1.view.usermanagement.admin.AddUserDetails',
	            'Salespro1.view.usermanagement.admin.ViewUser'],

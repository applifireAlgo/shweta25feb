 ...
 * 
 */
Ext.define("Salespro1.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Salespro1.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],

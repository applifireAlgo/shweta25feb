Ext.define('Salespro1.view.googlemaps.map.MapPanelController', {
	...
	createInfoWindow : function(marker, currentJson) {
		...
		google.maps.event.addListener(marker, 'click', function() {
			...
			// mainInfoWindow =
			// Ext.create('Salespro1.view.googlemaps.map.MarkerInfoWindowView',{title:
	...
	loadGoogleMap : function() {
		...
		// Ext.create('Salespro1.view.googlemaps.map.MarkerInfoWindowView').show();
	},
	resizeMap : function() {

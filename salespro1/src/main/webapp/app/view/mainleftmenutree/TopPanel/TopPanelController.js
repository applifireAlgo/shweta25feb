Ext.define('Salespro1.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	doVoiceSearch:function(btn){
		...
		if(searchTab.length==0){
			 component = Ext.create(
					"Salespro1.view.searchengine.search.SearchEngineMainPanel", {
						closable : true,
						title : "Search Engine",
						refId : "-1",
						isSearchCmp:true
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Salespro1.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					menuId:'cloudtab'
				});
	...
	{
		var component = Ext.create(
				"Salespro1.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile",
					menuId:'myprofiletab'
				});
	...
	{
		var component = Ext.create(
				"Salespro1.view.usermanagement.enduser.ChangePwd", {
					closable : true,

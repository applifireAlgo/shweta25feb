Ext.define('Salespro1.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Salespro1.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Salespro1.view.console.ConsoleWindow');

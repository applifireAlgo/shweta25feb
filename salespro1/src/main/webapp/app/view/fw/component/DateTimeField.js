 ...
 */
Ext.define('Salespro1.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Salespro1.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Salespro1.view.fw.component.DateTimePicker(o);
    },

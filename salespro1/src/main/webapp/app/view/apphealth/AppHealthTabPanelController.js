 ...
 * 
 */
Ext.define('Salespro1.view.apphealth.AppHealthTabPanelController',{
	extend : 'Ext.app.ViewController',
	alias : 'controller.appHealthTabPanelController',
	requires : ['Salespro1.view.apphealth.AppHealthConnector'],
						...
						success : function(response, opts){
							...
							if (responseJson.response.success) {
								...
								for(var i = 0; i < appHealthSchedulerData.length; i++)
								{
									...
									var connectorPanel = Ext.create("Salespro1.view.apphealth.AppHealthConnector", {

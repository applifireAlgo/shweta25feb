Ext
		.define(
				'Salespro1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Salespro1.view.searchengine.search.SearchEngineMainPanelController','Salespro1.view.searchengine.search.PanelHeaderField' ,'Salespro1.view.searchengine.search.ReportGridView','Salespro1.view.searchengine.search.ReportChartView','Salespro1.view.searchengine.search.documentView','Salespro1.view.searchengine.search.DouMeanView','Salespro1.view.googlemaps.map.MapPanel'],

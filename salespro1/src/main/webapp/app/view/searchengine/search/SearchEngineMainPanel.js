Ext.define('Salespro1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Salespro1.view.searchengine.search.NorthPanel', 'Salespro1.view.searchengine.search.SearchResult','Salespro1.view.searchengine.search.SearchEngineMainPanelController'],

...
Ext.define('Salespro1.view.mobileview.main.TopPanel.TopMenuController', {
 						...
 						menuData.push(
 						{
 							...
 							renderCentralPanel:function(currentObject,menu)
 							{
 								if(menu.config.data.uiType && menu.config.data.uiType=='M')
 								{
 	 									...
 	 									var component = Ext.create('Salespro1.view.mobileview.art.masterform.MasterPanel',{closable : true,title: menu.text, artMasterFormId:menu.config.data.refId});

Ext.define('Salespro1.view.mobileview.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Salespro1.view.mobileview.scheduler.scheduler"
		var component = Ext.create(
				"Salespro1.view.mobileview.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Salespro1.view.mobileview.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});

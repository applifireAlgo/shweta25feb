 ...
 */
Ext.define('Salespro1.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Salespro1.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Salespro1.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Salespro1.view.login.SessionLogin').center();

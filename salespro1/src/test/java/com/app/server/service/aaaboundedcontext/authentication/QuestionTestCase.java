...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("6oR5tQGgPanCugyiFS8jGUovM8wUA9l7fYa6cuTpMuAuR9ifYi");
            question.setQuestionDetails("x");
            question.setQuestionIcon("44aVOpEzOPYduccagqRZPYxbyC8ahsRMbml3vJ7pafL50u8TLY");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("NsN2xIMtpabdYpvYscJqYFFGCaogRJkWWoKUyl7ID3wyvEFNhY");
            question.setQuestionDetails("w");
            question.setVersionId(1);
            question.setQuestionIcon("DrlKbjKyJj8A7tKUT9C0rFTPygXW7tL4dVnZBHQfMs2hheBEkK");
